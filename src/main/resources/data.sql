...
INSERT INTO vehicle_categories (category_name, description, seating_capacity, base_rate)
VALUES ('Sedan', 'Comfortable 4-door family car', 5, 6000),
...
INSERT INTO vehicles (registration_no, brand, model, year, mileage, availability_status, category_id, fuel_consumption,
                      fuel_type)
VALUES ('WP-CAB-1234', 'Toyota', 'Corolla', 2022, 15000, 'AVAILABLE', 1, 15.5, 'PETROL'),
...
INSERT INTO employees (name, phone_no, email, position, role, driver_status)
VALUES ('Nimal Perera', '0711234567', 'nimal.driver@vrs.lk', 'Senior Driver', 'DRIVER', 'AVAILABLE'),
...
INSERT INTO fuel_price (fuel_type, price)
VALUES ('PETROL', '399.00'),
       ('DIESEL', '382.00')